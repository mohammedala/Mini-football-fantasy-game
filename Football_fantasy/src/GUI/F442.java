...
public class F442 extends javax.swing.JFrame {
    ...
    public F442(user u) throws ClassNotFoundException, SQLException {
        initComponents();
        ...
        try {
            jLabel1.setIcon(new javax.swing.ImageIcon("src\\images\\d7b05539aac8c5416c73ca046f977742_1_700x1000.jpg"));
        ...
        for (int i = 0; i <7; i++) {
            ...
            this.df4.insertItemAt(defender[i].getClub() + "  " + defender[i].getName(), i);
    ...
    private void initComponents() {
        ...
        jPanel1.add(df1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 154, 158, 33));
        ...
        jPanel1.add(df2, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 72, 158, 33));
        ...
        jPanel1.add(md1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 303, 158, 33));
        ...
        jPanel1.add(df3, new org.netbeans.lib.awtextra.AbsoluteConstraints(439, 72, 158, 33));

        df4.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        df4.setForeground(new java.awt.Color(0, 51, 153));
        df4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                df4ActionPerformed(evt);
            }
        });
        jPanel1.add(df4, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 154, 150, 33));
        ...
        jPanel1.add(gk1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 158, 33));
        ...
        jPanel1.add(md3, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 223, 158, 33));
        ...
        jPanel1.add(md4, new org.netbeans.lib.awtextra.AbsoluteConstraints(532, 303, 150, 33));
        ...
        jPanel1.add(md2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 223, 158, 33));
        ...
        jPanel1.add(fw2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 400, 158, 33));
        ...
        jPanel1.add(fw1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 400, 158, 33));
        ...
        jLabel2.setText("FW");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 380, -1, -1));
        ...
        jLabel7.setText("DF");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 130, -1, -1));

        jLabel8.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("MID");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 200, -1, -1));
        ...
        jLabel10.setText("MID");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, -1, -1));
        ...
        jLabel12.setText("FW");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 370, -1, -1));
                ...
                for (int j = 1; j < 11; j++) {
                    if (i != j) {
                        if (single_player.getPlayerNamefromSquad(i).equalsIgnoreCase(single_player.getPlayerNamefromSquad(j))) {
                            JOptionPane.showMessageDialog(null, "you cannot select the same player twice", "warrning", JOptionPane.WARNING_MESSAGE);
                            flag1 = false;
                            break;
                        }
                    }
            ...
            for (int i = 0; i < 11; i++) {
                ...
                for (int j = 0; j < 11; j++) {
                    if (single_player.getClubSquad(i).equalsIgnoreCase(single_player.getClubSquad(j))) {
                        counter++;
                        if (counter > 3) {
                            JOptionPane.showMessageDialog(null, "you cannot select more than 3 players from the same club", "warrning", JOptionPane.WARNING_MESSAGE);
                            flag2 = false;
                            break;
                        }
                    }
    ...
    private void df4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_df4ActionPerformed
        ...
        single_player.instantiate(4, 2);
        String playerName = String.valueOf(df4.getSelectedItem()).substring(4);
        String clubName = String.valueOf(df4.getSelectedItem()).substring(0, 3);
        for (int i = 0; i < defender.length; i++) {
            if (defender[i].getName().trim().replaceAll("\\s+", "").equalsIgnoreCase(playerName.trim().replaceAll("\\s+", ""))) {
                single_player.setList(4, defender[i].getName(), defender[i].getClub(),
    ...
    private javax.swing.JComboBox<String> df4;
